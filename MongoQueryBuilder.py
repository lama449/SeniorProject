...
This is a simple code to push a facility into the database.
10/12/19
'''
...
mydict = {"name": facTitle, "address": [{"address_L1": addressLine1, "address_L2": addressLine2,
          ...
          "access_code": accessCode, "private": False, "phone": phone, "description": desc, "buildings": [],
          "groups": [], "presets": [], "attributes:": [], "maintenance": [], "reservation": []}
